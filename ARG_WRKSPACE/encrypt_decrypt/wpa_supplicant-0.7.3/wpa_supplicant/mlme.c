...
#define IEEE80211_AUTH_TIMEOUT (2000)//just for testing.
#define IEEE80211_AUTH_MAX_TRIES 10
//#define IEEE80211_ASSOC_TIMEOUT (20000)
#define IEEE80211_ASSOC_TIMEOUT (200000)//just for testing.
...
static void ieee80211_rx_mgmt_probe_resp(struct wpa_supplicant *wpa_s,
					 ...
					 struct ieee80211_rx_status *rx_status)
{
	wpa_printf(MSG_DEBUG, "WPA_SUPPLICANT: rx_mgmt_probe_resp\n");
			    ...
			    struct wpa_driver_associate_params *params)
{
	...
	wpa_printf(MSG_DEBUG, "MAC_FRAME_WORK-RAEMSH: its in ieee80211_sta_associate\n");
